...
class Agent:
    ...
    def choose_action(self, observation): 
        ...
        action = action.numpy()[0] if tf.is_tensor(action) else action[0] 
        value = value.numpy()[0] if tf.is_tensor(value) else value[0] 
        log_prob = log_prob.numpy()[0] if tf.is_tensor(log_prob) else log_prob[0] 
